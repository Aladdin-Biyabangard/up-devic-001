...
const CourseDetailPage = () => {
  ...
  const handleAddComment = async (content: string) => {
    const newComment = await api.addCommentToCourse(courseId, content);
  ...
  const mainTeacherId: number | undefined = (course?.teacherId || course?.headTeacher || course?.headTeacher?.id) as number | undefined;
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription>Share your thoughts about this course</CardDescription>
              </CardHeader>
              <CardContent>
                <CommentList
                  comments={comments}
